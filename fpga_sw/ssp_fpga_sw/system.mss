...
BEGIN OS
 ...
 PARAMETER pthread_stack_size = 6000
 PARAMETER config_pthread_mutex = true
 PARAMETER config_time = true
 PARAMETER config_sema = true
 PARAMETER max_sem = 40
 PARAMETER max_pthreads = 17
 PARAMETER n_prio = 8
 PARAMETER max_pthread_mutex = 11
 PARAMETER sched_type = SCHED_PRIO
 PARAMETER static_pthread_table = ((main_main,4))
END
...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -g -DTCPIP_THREAD_PRIO=2
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = arp_ssp_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = arp_ssp_2
END
