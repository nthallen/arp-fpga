...
ARCHITECTURE rtl OF bench_Digo_Conn IS
   ...
   SIGNAL IO3    : std_logic_vector(7 DOWNTO 0);
...
BEGIN
  ...
  test_proc : Process
    ...
    Begin
      --pragma synthesis_off
      assert IO1 = IO1in report "IO1 not correct" severity error;
      assert IO2 = IO2in report "IO2 not correct" severity error;
      assert IO3 = IO3in report "IO3 not correct" severity error;
      assert Dir1 = Dirs(0) report "Dir1 not correct" severity error;
      assert Dir2 = Dirs(1) report "Dir2 not correct" severity error;
      assert Dir3 = Dirs(2) report "Dir3 not correct" severity error;
      --pragma synthesis_on
      return;
    End Procedure;
    procedure check_in ( 
