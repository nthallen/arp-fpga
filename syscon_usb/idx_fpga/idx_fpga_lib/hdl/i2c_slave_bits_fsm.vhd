...
--   sda     INOUT   'Z'                           COMB   
--   nb      LOCAL                (others => '0')  CLKD   
--   sr      LOCAL                (others => '0')  CLKD   
--   addd    LOCAL                '0'              CLKD   
--   sclq    LOCAL   To_X01(scl)                   COMB   
--   sdaq    LOCAL   To_X01(sda)                   COMB   
--   rval    LOCAL                X"55"            CLKD   
--   wdata   OUT                  (others => '0')  CLKD   
--   RE      INOUT   'L'                           COMB   
--   WE      OUT                  '0'              CLKD   
--   
LIBRARY ieee;
