-- VHDL Entity idx_fpga_lib.lk204_to.interface
--
-- Created:
--          by - nort.UNKNOWN (NORT-NBX200T)
--          at - 14:14:26 09/12/2012
--
...
--
-- VHDL Architecture idx_fpga_lib.lk204_to.fsm
--
-- Created:
--          by - nort.UNKNOWN (NORT-NBX200T)
--          at - 14:14:27 09/12/2012
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2012.1 (Build 6)
--
LIBRARY ieee;
...
ARCHITECTURE fsm OF lk204_to IS
...
BEGIN
   ...
   BEGIN
      ...
      IF (csm_to_qt_wait = '1') THEN
         csm_next_timer <= "11000011010011111111"; -- no cycles(800000)-1=799999
      ELSE
