...
BEGIN
   ...
   BEGIN
      CASE current_state IS
         WHEN i2c_0 => 
            IF (SCL = '1' AND To_X01(SDA) = '0') THEN 
               next_state <= i2c_1;
            ELSE
               next_state <= i2c_0;
            END IF;
         ...
         WHEN i2c_3 => 
            IF (SCL = '0' AND
                 NB /= 8) THEN 
               next_state <= i2c_2;
            ELSIF (SCL = '0' AND NB = 8) THEN 
               next_state <= i2c_4;
            ELSE
               next_state <= i2c_3;
            END IF;
         WHEN i2c_ng => 
            IF (SCL = '1' AND To_X01(SDA) = '1') THEN 
               next_state <= i2c_0;
            ELSE
               next_state <= i2c_ng;
            END IF;
         ...
         WHEN i2c_r3 => 
            IF (SCL = '1' AND To_X01(SDA) = '0') THEN 
               next_state <= i2c_r4;
            ELSIF (SCL = '1' AND To_X01(SDA) /= '0') THEN 
               next_state <= i2c_r5;
            ELSE
               next_state <= i2c_r3;
            END IF;
         ...
         WHEN i2c_w4 => 
            IF (SCL = '1' AND To_X01(SDA) = '1') THEN 
               next_state <= i2c_1;
            ELSIF (SCL = '1' AND To_X01(SDA) /= '1') THEN 
               next_state <= i2c_ng;
            ELSE
               next_state <= i2c_w4;
            END IF;
