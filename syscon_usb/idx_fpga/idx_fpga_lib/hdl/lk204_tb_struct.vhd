...
ARCHITECTURE struct OF lk204_tb IS
   ...
   SIGNAL WE       : std_logic;
   SIGNAL rdata1   : std_logic_vector(7 DOWNTO 0) := (others => '0');
   ...
   FOR ALL : mock_9554_out USE ENTITY idx_fpga_lib.mock_9554_out;
   -- pragma synthesis_on
