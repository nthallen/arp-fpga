...
--
-- VHDL Architecture idx_fpga_lib.powermon.fsm
--
-- Created:
--          by - nort.UNKNOWN (NORT-XPS14)
...
ARCHITECTURE fsm OF powermon IS

  -- Architecture Declarations
  SIGNAL Status : std_logic_vector(15 DOWNTO 0);

  type pmAddrs_t is array (0 TO 8) of std_logic_vector(7 DOWNTO 0);
  CONSTANT pmAddrs_t : pmAddrs := (
    "1100111",
    "1101000",
    "1101001",
    "1101010",
