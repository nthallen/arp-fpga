...
BEGIN
   ...
   BEGIN
      ...
      IF (csm_to_acq_idle = '1') THEN
         csm_next_timer <= "0000000001001"; -- no cycles(10)-1=9
      ELSIF (csm_to_acq_conv = '1') THEN
         csm_next_timer <= "0000000011111"; -- no cycles(32)-1=31
      ELSIF (csm_to_acq_settle = '1') THEN
         csm_next_timer <= "1101111111001"; -- no cycles(7162)-1=7161
      ELSE
