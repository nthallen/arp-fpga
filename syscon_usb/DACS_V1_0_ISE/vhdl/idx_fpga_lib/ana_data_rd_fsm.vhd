...
ARCHITECTURE fsm OF ana_data_rd IS
   ...
   SIGNAL RAM_CFG : std_logic_vector(4 DOWNTO 0);  
            ...
            CASE current_state IS
               WHEN ana_rd0 => 
                  ...
                  ELSIF (RDEN = '1' AND 
                     ...
                     RD_DATA_cld(4 DOWNTO 0) <= RAM_CFG;
                     RD_DATA_cld(15 DOWNTO 5) <= (others => '0');
                  ELSIF (RDEN = '1' AND 
                         RD_ADDR ( 0 ) = '1' AND 
                         RD_ADDR (8 DOWNTO 1) /= RAM_ADDR_hold) THEN 
                     RD_DATA_cld <= X"0020";
               ...
               WHEN ana_rd3 => 
                  ...
                  RAM_CFG <= RAM_RD_DATA(20 DOWNTO 16);
               WHEN OTHERS =>
                  NULL;
            END CASE;
         END IF;
