...
ARCHITECTURE fsm OF lk204_sm IS
   ...
   SIGNAL OutValW : std_logic_vector(7 DOWNTO 0);  
   SIGNAL PCA_Set : std_logic;  
      ...
      IF (F8M'EVENT AND F8M = '1') THEN
         ...
         ELSE
            ...
            CASE current_state IS
               ...
               WHEN wr_5 => 
                  OutVal(5 downto 4) <=
                   OutVal(5 downto 4) AND
                    (NOT CharData(5 downto 4));
                  RE_cld <= '1';
               WHEN rd_25 => 
                  OutVal(4) <= '1';
               WHEN wr_38 => 
                  I2Cwdata_cld <= OutVal xor X"30";
                  OutValW <= OutVal;
                  WrStart_cld <= '0';
                  WrStop_cld <= '1';
                  WrI2C_cld <= '1';
